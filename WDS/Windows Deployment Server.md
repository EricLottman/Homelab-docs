...
| --- | --- | --- |
| Win10Pro | Windows 10 Pro | Supports legacy applications, to be used where needed (due to hardware limitations, will be used as standard) |
| Win11Pro | Windows 11 Pro | Default Operating System for Client (due to hardware limitations, very likely to be unused) |
